...
var logger = new (winston.Logger)({
    transports: [
        ...
        new (winston.transports.File)({name:'info_logger',filename: './/logs//proxy-aca-info.log',level:'info',json: true }),
        new (winston.transports.File)({name:'error_logger',filename: './/logs//proxy-aca-error.log',level:'error',json: true })
    ]
});
